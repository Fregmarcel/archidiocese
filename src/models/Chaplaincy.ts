...
export interface IChaplaincy {
  _id?: string;
  name: string;
  description: string;
  type?: string; // 'hospital', 'school', 'university', 'military', etc.
  chaplain?: string;
...
const ChaplainchySchema = new mongoose.Schema({
...
export default mongoose.models.Chaplaincy || mongoose.model<IChaplaincy>('Chaplaincy', ChaplainchySchema);
